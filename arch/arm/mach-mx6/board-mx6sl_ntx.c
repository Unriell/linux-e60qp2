...
static int _MYINIT_TEXT hwcfg_p_setup(char *str)
{
	...
	gptHWCFG->m_val.bProgressXHiByte = 0x02;
	gptHWCFG->m_val.bProgressXLoByte = 0xec;
	gptHWCFG->m_val.bProgressYHiByte = 0x05;
	gptHWCFG->m_val.bProgressYLoByte = 0x45;
...
static struct gpio_keys_button gpio_key_TP_PGUP_PGDN[] = {
	GPIO_BUTTON(GPIO_KB_COL0, KEY_F1, 1, "TP_ON", 1,1),			// TP_ON
	GPIO_BUTTON(GPIO_KB_COL1, KEY_PAGEUP, 1, "PG_UP", 1,1),			// PG_UP
	GPIO_BUTTON(GPIO_KB_COL3, KEY_PAGEDOWN, 1, "PG_DN", 1,1),			// PG_DN 
//#ifdef CONFIG_ANDROID //[
	GPIO_BUTTON(IMX_GPIO_NR(5, 8), KEY_POWER, 1, "power", 1, 1),
//#endif //]CONFIG_ANDROID
};
		...
		default:
			...
			case 18: // HOMEPAD
		        ...
		        case 22: // LEFT+RIGHT+HOME+MENU
		          ...
		          break;
		        case 23: // TP+PGUP+PGDN
		          ntx_gpio_key_data.buttons = gpio_key_TP_PGUP_PGDN;
		          ntx_gpio_key_data.nbuttons = ARRAY_SIZE(gpio_key_TP_PGUP_PGDN);
		          break;
